import {Films, genreType} from './movie.model';
...
export const movies: Films[] = [
  ...
  },
  {
    ...
    description: 'A veteran pot dealer creates a fake family as part ' +
      'of his plan to move a huge shipment of weed into the U.S. from Mexico.',
